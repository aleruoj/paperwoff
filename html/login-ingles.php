                            ...
                            <div class="form-check form-check-inline col-md-12 mt-4 mb-3">
                                <div class="row m-0">
                                    <div class="col-md-7 col-6 p-0 fl-checkbox">
                                        ...
                                        <label class="form-check-label check-mobile legal-form m-0 p-0"
                                            for="check-remember">
                                            Remember me
                                        </label>
                                    </div>
                                    <div class="col-md-5 col-6 p-0">
                                        <p class="legal-form text-right m-0 olvide-pass">
                                            <a href="" data-toggle="modal" data-target="#recuperarpassword">Forgot my password</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <button type="submit" class="btn btn-default button-primary my-4 m-0">Send</button>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Recover your account</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <p>Enter you e-mail</p>
          
          
          
          <form>
            <div class="form-group">
              <input type="email" class="form-control" id="exampleInputEmail1" required aria-describedby="emailHelp" placeholder="E-mail">
